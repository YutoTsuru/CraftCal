...
export function BackgroundDecor() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute -bottom-20 left-1/4 w-[60vw] h-[40vh] rounded-full blur-3xl opacity-40 bg-gradient-to-r from-amber-200 via-purple-200 to-amber-200 animate-decor-motion" />
    </div>
  );
}
